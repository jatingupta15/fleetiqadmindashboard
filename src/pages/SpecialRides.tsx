  ...
  const [bookingRequests, setBookingRequests] = useState([
    {
      ...
      employeeId: 'EMP002',
      department: 'HR',
      loginLocation: 'Sector 62, Noida',
      logoutLocation: 'Airport Terminal 3',
      rideDate: '2024-01-20',
      rideTime: '14:00',
      tripType: 'both',
    ...
    },
    {
      ...
      logoutLocation: 'Bangalore Railway Station',
      rideDate: '2024-01-18',
      rideTime: '06:30',
      tripType: 'login-only',
    ...
    },
    {
      ...
      loginLocation: 'Gurgaon Office',
      logoutLocation: 'Max Hospital, Saket',
      rideDate: '2024-01-16',
      rideTime: '10:00',
      tripType: 'logout-only',
